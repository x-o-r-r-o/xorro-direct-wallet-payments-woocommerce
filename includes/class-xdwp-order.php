		...
		wp_localize_script(
			...
			array(
				...
				'i18n'      => array(
					...
					'walletConnect'       => __( 'Pay from a wallet on your phone', 'xorro-direct-wallet-payments-woocommerce' ),
					'walletConnecting'    => __( 'Opening the wallet connector…', 'xorro-direct-wallet-payments-woocommerce' ),
					'walletConnectFailed' => __( 'The wallet connector could not be loaded. Send the payment from your wallet using the address above instead.', 'xorro-direct-wallet-payments-woocommerce' ),
