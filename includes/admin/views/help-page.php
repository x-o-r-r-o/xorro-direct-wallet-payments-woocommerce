				...
				<div class="cc-panel is-active">
					...
					<div class="cc-panel-content xdwp-help">
						...
						<section id="xdwp-help-start" class="xdwp-help__section">
							...
							<p class="xdwp-help__note"><?php esc_html_e( 'Most coins confirm payments automatically. Three are confirmed by hand — Monero, Polkadot and IoTeX — so for those you use "Mark payment received" on the order. Kaia is automatic once you add a free Kaiascan key under Prices & APIs. The Coins tab says which is which.', 'xorro-direct-wallet-payments-woocommerce' ); ?></p>
						</section>
						...
						<section id="xdwp-help-prices" class="xdwp-help__section">
							...
							<p><strong><?php esc_html_e( 'Backup and restore', 'xorro-direct-wallet-payments-woocommerce' ); ?></strong> — <?php esc_html_e( 'at the bottom of General, Wallets and Prices &amp; APIs. Downloads the configuration as one file, and you choose how much of it: everything (coins, addresses, extended keys, limits, confirmations and prices), the wallet addresses and extended keys on their own, or the API keys on their own. API keys are left out unless you tick the box — so a file you email or keep in a repository carries no secrets — except in the keys-only file, which exists to carry them and should be treated as a password. There is never a private key in any of them, because this plugin does not hold one. Restoring changes only what the file contains and leaves the rest of this site alone, putting every value through the same checks as typing it in by hand.', 'xorro-direct-wallet-payments-woocommerce' ); ?></p>
						</section>
